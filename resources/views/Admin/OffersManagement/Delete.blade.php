...
@section('content')
    <div class="p1"><label
                style="font-size: 40px; margin-top:9%; color: white; font-weight: bold; margin-right: 12%;"><span
                    class="glyphicon glyphicon-remove" style="color:#f73917;"></span>&nbsp;حـذف عرض سـياحـي</label>
    </div>
    <br>
    ...
    color:#f73917; font-weight: bold;"><span class="glyphicon glyphicon-remove" style="color:#f73917;"></span>&nbsp;
                هل تريد بالتأكيد القيام بعملية حذف عرض سياحي ؟</label>
            <hr>
            <br>
            <br>
            <form action="{{route('Offers.destroy',$data['offer_id'])}}" method="post">
                {{csrf_field()}}
                @method('DELETE')
                        ...
                        <div style="font-size: 22px; font-weight: bold; color:#64AEF7;margin-right: 80px;">
                            ...
                            <button type="submit" class="btn btn-info"
                                    style="color: white; width: 100px;height: 40px; font-size: 20px;"><span
                                        class="glyphicon glyphicon-remove" style="color: orange;"></span>حذف
                            </button>
